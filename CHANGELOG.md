...
### Added
- **Breaking:** Add support for "lts" and "latest" versions of CRS ([#80](https://github.com/united-security-providers/coraza-envoy-go-filter/pull/80))([daum3ns](https://github.com/daum3ns))

### Changed
- Update CRS to version 4.25 ([#80](https://github.com/united-security-providers/coraza-envoy-go-filter/pull/80))([daum3ns](https://github.com/daum3ns))
